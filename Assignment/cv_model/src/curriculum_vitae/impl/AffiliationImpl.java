 ...
 *   <li>{@link curriculum_vitae.impl.AffiliationImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AffiliationImpl extends MinimalEObjectImpl.Container implements Affiliation {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Curriculum_vitaePackage.AFFILIATION__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Curriculum_vitaePackage.AFFILIATION__END:
				return getEnd();
			case Curriculum_vitaePackage.AFFILIATION__DESCRIPTION:
