 ...
 * @generated
 */
public class Curriculum_vitaeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Curriculum_vitaePackage.CITATION_NAME: {
				CitationName citationName = (CitationName)theEObject;
				T result = caseCitationName(citationName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Curriculum_vitaePackage.AFFILIATION: {
				...
				T result = caseAffiliation(affiliation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Curriculum_vitaePackage.AFFILIATION_FIELD: {
				AffiliationField affiliationField = (AffiliationField)theEObject;
				T result = caseAffiliationField(affiliationField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Curriculum_vitaePackage.DISTINCTION: {
				Distinction distinction = (Distinction)theEObject;
				T result = caseDistinction(distinction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Curriculum_vitaePackage.DISTINCTION_TYPE: {
				DistinctionType distinctionType = (DistinctionType)theEObject;
				T result = caseDistinctionType(distinctionType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Citation Name</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Citation Name</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCitationName(CitationName object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseAffiliation(Affiliation object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Affiliation Field</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Affiliation Field</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAffiliationField(AffiliationField object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Distinction</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Distinction</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDistinction(Distinction object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Distinction Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Distinction Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDistinctionType(DistinctionType object) {
		return null;
	}
