 ...
 * using:
 *   /cv_model/model/cv_model_gen.genmodel
...
public class Curriculum_vitaeTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ DataTypeId DATAid_ELong = Curriculum_vitaeTables.PACKid_http_c_s_s_www_eclipse_org_s_emf_s_2002_s_Ecore.getDataTypeId("ELong", 0);
	...
	public static final /*@NonInvalid*/ String STR_c1 = "c1";
	public static final /*@NonInvalid*/ String STR_c2 = "c2";
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Activity = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Activity, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ActivityType = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_ActivityType, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Affiliation = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Affiliation, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_AffiliationField = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_AffiliationField, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_CitationName = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_CitationName, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Degree = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Degree, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Distinction = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Distinction, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_DistinctionType = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_DistinctionType, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Idiom = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Idiom, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Project = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Project, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Technology = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Technology, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Website = TypeId.ORDERED_SET.getSpecializedId(Curriculum_vitaeTables.CLSSid_Website, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Affiliation__description = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.AFFILIATION__DESCRIPTION, Types._Affiliation, 0);
		public static final ExecutorProperty _Affiliation__employer = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.AFFILIATION__EMPLOYER, Types._Affiliation, 1);
		public static final ExecutorProperty _Affiliation__end = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.AFFILIATION__END, Types._Affiliation, 2);
		...
		public static final ExecutorProperty _AffiliationField__Person__affiliation_fields = new ExecutorPropertyWithImplementation("Person", Types._AffiliationField, 2, new EcoreLibraryOppositeProperty(Curriculum_vitaePackage.Literals.PERSON__AFFILIATION_FIELDS));
		...
		public static final ExecutorProperty _Idiom__native_lang = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.IDIOM__NATIVE_LANG, Types._Idiom, 2);
		public static final ExecutorProperty _Idiom__reading_qual = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.IDIOM__READING_QUAL, Types._Idiom, 3);
		public static final ExecutorProperty _Idiom__speaking_qual = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.IDIOM__SPEAKING_QUAL, Types._Idiom, 4);
		public static final ExecutorProperty _Idiom__writing_qual = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.IDIOM__WRITING_QUAL, Types._Idiom, 5);
		public static final ExecutorProperty _Idiom__Person__idioms = new ExecutorPropertyWithImplementation("Person", Types._Idiom, 6, new EcoreLibraryOppositeProperty(Curriculum_vitaePackage.Literals.PERSON__IDIOMS));
		...
		public static final ExecutorProperty _Person__affiliation_fields = new EcoreExecutorProperty(Curriculum_vitaePackage.Literals.PERSON__AFFILIATION_FIELDS, Types._Person, 1);
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Affiliation = {
			Curriculum_vitaeTables.Properties._Affiliation__description,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Idiom = {
			...
			Curriculum_vitaeTables.Properties._Idiom__native_lang,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Person = {
			...
			Curriculum_vitaeTables.Properties._Person__affiliation_fields,
