...
/**
 * This is the item provider adapter for a {@link curriculum_vitae.Technology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Curriculum_vitaePackage.Literals.TECHNOLOGY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addProficiencyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Technology_proficiency_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Technology_proficiency_feature", "_UI_Technology_type"),
				 Curriculum_vitaePackage.Literals.TECHNOLOGY__PROFICIENCY,
				 true,
				 false,
				 false,
