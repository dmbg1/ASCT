...
public class Curriculum_vitaePackageImpl extends EPackageImpl implements Curriculum_vitaePackage {
	 ...
	 * @generated
	 */
	public EReference getPerson_Affiliation_categories() {
	 ...
	 * @generated
	 */
	public EAttribute getAffiliation_Host_institution() {
	...
	public void createPackageContents() {
		...
		createEReference(personEClass, PERSON__AFFILIATION_CATEGORIES);
		...
		createEAttribute(affiliationEClass, AFFILIATION__HOST_INSTITUTION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPerson_Phone_number(), ecorePackage.getEInt(), "phone_number", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPerson_Affiliation_categories(), this.getAffiliationField(), null, "affiliation_categories", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAffiliation_Host_institution(), ecorePackage.getEString(), "host_institution", null, 0, 1, Affiliation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
