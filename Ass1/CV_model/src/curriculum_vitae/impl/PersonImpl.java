 ...
 *   <li>{@link curriculum_vitae.impl.PersonImpl#getAffiliation_categories <em>Affiliation categories</em>}</li>
...
public class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	 ...
	 * @ordered
	 */
	protected int phone_number = PHONE_NUMBER_EDEFAULT;
	...
	/**
	 * The cached value of the '{@link #getAffiliation_categories() <em>Affiliation categories</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAffiliation_categories()
	 * @generated
	 * @ordered
	 */
	protected EList<AffiliationField> affiliation_categories;
	...
	/**
	 * The cached value of the '{@link #getActivity_types() <em>Activity types</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setPhone_number(int newPhone_number) {
		int oldPhone_number = phone_number;
	 ...
	 * @generated
	 */
	public EList<AffiliationField> getAffiliation_categories() {
		if (affiliation_categories == null) {
			affiliation_categories = new EObjectContainmentEList<AffiliationField>(AffiliationField.class, this, Curriculum_vitaePackage.PERSON__AFFILIATION_CATEGORIES);
		}
		return affiliation_categories;
	}
	...
	public EList<ActivityType> getActivity_types() {
		if (activity_types == null) {
			activity_types = new EObjectResolvingEList<ActivityType>(ActivityType.class, this, Curriculum_vitaePackage.PERSON__ACTIVITY_TYPES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Curriculum_vitaePackage.PERSON__AFFILIATION_CATEGORIES:
				return ((InternalEList<?>)getAffiliation_categories()).basicRemove(otherEnd, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Curriculum_vitaePackage.PERSON__PROJECTS:
				return getProjects();
			case Curriculum_vitaePackage.PERSON__AFFILIATION_CATEGORIES:
				return getAffiliation_categories();
			case Curriculum_vitaePackage.PERSON__DISTINCTION_TYPES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Curriculum_vitaePackage.PERSON__DATE_OF_BIRTH:
				...
				return;
			case Curriculum_vitaePackage.PERSON__PHONE_NUMBER:
				setPhone_number((Integer)newValue);
				return;
			case Curriculum_vitaePackage.PERSON__HOME_ADDRESS:
			...
			case Curriculum_vitaePackage.PERSON__PROJECTS:
				...
				return;
			case Curriculum_vitaePackage.PERSON__AFFILIATION_CATEGORIES:
				getAffiliation_categories().clear();
				getAffiliation_categories().addAll((Collection<? extends AffiliationField>)newValue);
				return;
			case Curriculum_vitaePackage.PERSON__DISTINCTION_TYPES:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Curriculum_vitaePackage.PERSON__AFFILIATION_CATEGORIES:
				return affiliation_categories != null && !affiliation_categories.isEmpty();
			case Curriculum_vitaePackage.PERSON__DISTINCTION_TYPES:
