 ...
 *   <li>{@link curriculum_vitae.Person#getAffiliation_categories <em>Affiliation categories</em>}</li>
...
public interface Person extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Affiliation categories</b></em>' containment reference list.
	 * The list contents are of type {@link curriculum_vitae.AffiliationField}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Affiliation categories</em>' containment reference list.
	 * @see curriculum_vitae.Curriculum_vitaePackage#getPerson_Affiliation_categories()
	 * @model containment="true"
	 * @generated
	 */
	EList<AffiliationField> getAffiliation_categories();
	...
	/**
	 * Returns the value of the '<em><b>Activity types</b></em>' reference list.
	 * The list contents are of type {@link curriculum_vitae.ActivityType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Activity types</em>' reference list.
