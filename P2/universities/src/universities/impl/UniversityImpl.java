 ...
 * </p>
 * <ul>
 *   <li>{@link universities.impl.UniversityImpl#getName <em>Name</em>}</li>
 *   <li>{@link universities.impl.UniversityImpl#getFaculties <em>Faculties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
	...
	protected EClass eStaticClass() {
		return UniversitiesPackage.Literals.UNIVERSITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversitiesPackage.UNIVERSITY__NAME, oldName, name));
	}
	...
	public EList<Faculty> getFaculties() {
		if (faculties == null) {
			faculties = new EObjectContainmentEList<Faculty>(Faculty.class, this, UniversitiesPackage.UNIVERSITY__FACULTIES);
		}
		return faculties;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UniversitiesPackage.UNIVERSITY__FACULTIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UniversitiesPackage.UNIVERSITY__NAME:
				return getName();
			case UniversitiesPackage.UNIVERSITY__FACULTIES:
				return getFaculties();
		}
