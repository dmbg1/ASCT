...
public class EditionImpl extends MinimalEObjectImpl.Container implements Edition {
	...
	public EList<Professor> getProfessors() {
		if (professors == null) {
			professors = new EObjectContainmentEList<Professor>(Professor.class, this, UniversitiesPackage.EDITION__PROFESSORS);
		}
		return professors;
	}
	...
	public EList<Student> getStudents() {
		if (students == null) {
			students = new EObjectContainmentEList<Student>(Student.class, this, UniversitiesPackage.EDITION__STUDENTS);
		}
		return students;
	}
