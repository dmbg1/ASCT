 ...
 * </p>
 * <ul>
 *   <li>{@link universities.impl.ProfessorImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfessorImpl extends MinimalEObjectImpl.Container implements Professor {
	...
	protected EClass eStaticClass() {
		return UniversitiesPackage.Literals.PROFESSOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversitiesPackage.PROFESSOR__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UniversitiesPackage.PROFESSOR__NAME:
				return getName();
		}
