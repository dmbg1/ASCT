...
public class FacultyImpl extends MinimalEObjectImpl.Container implements Faculty {
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectResolvingEList<Course>(Course.class, this, UniversitiesPackage.FACULTY__COURSES);
		}
		return courses;
	}
	...
	public EList<Professor> getProfessors() {
		if (professors == null) {
			professors = new EObjectResolvingEList<Professor>(Professor.class, this, UniversitiesPackage.FACULTY__PROFESSORS);
		}
		return professors;
	}
